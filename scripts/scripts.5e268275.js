...
.constant('ENV', {name:'production',apiEndpoint:'http://live-todo-restful.pantheonsite.io'})
...
angular.module('todomvc')
	.controller('TodoCtrl', function TodoCtrl($scope, $routeParams, $filter, store, ENV) {
		'use strict';
 ...
 */
angular.module('todomvc')
	.factory('todoStorage', function ($http, $injector, ENV) {
		'use strict';

		// Detect if an API backend is present. If so, return the API module, else
		// hand off the localStorage adapter
		return $http.get(ENV.apiEndpoint + '/api')
			.then(function () {
	...
	.factory('api', function ($http, ENV) {
		...
		var store = {
			...
			delete: function (todo) {
				...
				return $http.delete(ENV.apiEndpoint + '/api/todos/' + todo.id)
					.then(function success() {
						return store.todos;
					}, function error() {
						angular.copy(originalTodos, store.todos);
			...
			put: function (todo) {
				...
				return $http.put(ENV.apiEndpoint + '/api/todos/' + todo.id, todo)
					.then(function success() {
						return store.todos;
					}, function error() {
						angular.copy(originalTodos, store.todos);
